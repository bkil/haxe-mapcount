...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{105, 109, 4745537, 5393365, 5442204, 5594513, 5741474, 57476627, 76061764, 78945784, 87367608, 142301684, 221637784, 302979532, 312752480, 328878574, 359333139, 407283053, 437335495, 452737314, 480756972, 501039929, 520590566, 537630174, 572311959, 630156697, 746281503, 834174833, 863972113, 922671056, 946786476, 995006396, 1067353468, 1071652316, 1103412149, 1177754921, 1181037546, 1204816148, 1224901875, 1228056441, 1247875546, 1257164128, 1273207865, 1280549057, 1280845662, 1282943179, 1313416818, 1352786672, 1395555037, 1398464674, 1431819701, 1436822557, 1460447810, 1512997393, 1532710347, 1537812987, 1547539107, 1620824029, 1621420777, 1623148745, 1639293562, 1648581351, 1705629508, 1768617329, 1825849507, 1830310359, 1915412854, 1916009602, 1937159360, 1981972957, 2022294396, 2025055113, 2048392659, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"i", "m", "__a", "len", "map", "pop", "set", "getEnumConstructs", "remove", "__previousException", "filter", "resize", "__nativeException", "methodName", "get_native", "iterator", "lastIndexOf", "hasNext", "message", "reverse", "nOccupied", "insert", "length", "get_message", "native", "array", "contains", "value", "__nativeStack", "cachedIndex", "toString", "hashes", "splice", "exists", "copy", "__skipStack", "join", "concat", "next", "enumConstructor", "push", "keyValueIterator", "current", "size", "sort", "quicksort", "vals", "spliceVoid", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "__ownStack", "posInfos", "concatNative", "nBuckets", "className", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "fileName", "toDynamic", "allEnums", "unwrap", "customParams", "__get", "__set", "__hx_deleteField", "lineNumber", "upperBound", "unshift", "_keys", "enumParameters", "shift", "slice"};
