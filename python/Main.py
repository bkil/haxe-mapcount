...
class Main:
    ...
    @staticmethod
    def main():
        def _hx_local_2(clientId,_hx_map):
            def _hx_local_1():
                def _hx_local_0(entry):
                    return (clientId in entry.h)
                return Lambda.count(_hx_map,_hx_local_0)
            return _hx_local_1()
        countClient = _hx_local_2
        ...
        _g.h["Zsoc"] = _g1
        _hx_map = _g
        print(str(countClient("OSX",_hx_map)))
