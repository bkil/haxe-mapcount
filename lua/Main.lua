...
Main.new = {}
Main.main = function() 
  local countClient = function(clientId,map) 
    do return Lambda.count(map, function(entry) 
      do return entry.h[clientId] ~= nil end;
    end) end;
  end;
  local _g = __haxe_ds_StringMap.new();
  local _g1 = __haxe_ds_StringMap.new();
  _g1.h.OSX = "1";
  _g1.h.QNX = "2";
  local value = _g1;
  if (value == nil) then 
    _g.h.Balu = __haxe_ds_StringMap.tnull;
  else
    _g.h.Balu = value;
  end;
  local _g1 = __haxe_ds_StringMap.new();
  ...
  local value = _g1;
  if (value == nil) then 
    _g.h.Tomi = __haxe_ds_StringMap.tnull;
  else
    _g.h.Tomi = value;
  end;
  local _g1 = __haxe_ds_StringMap.new();
  ...
  local value = _g1;
  if (value == nil) then 
    _g.h.Zsoc = __haxe_ds_StringMap.tnull;
  else
    _g.h.Zsoc = value;
  end;
  local map = _g;
  __haxe_Log.trace(countClient("OSX", map), _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="Main.hx",lineNumber=15,className="Main",methodName="main"}));
end
